...
- Event class: PostUpdateOfferEventJS (third-party)
...
| ---- | ---------- | ----------- | ------- |
| invoke | AbstractVillager, MerchantOffers |  | void | ✔ |
| addOffer | MerchantOffer |  | void | ✘ |
| addTrade | VillagerTrades$ItemListing |  | void | ✘ |
...
| createRandomOffer | List<VillagerTrades$ItemListing> |  | MerchantOffer | ✘ |
