...
declare module "@package/com/mojang/datafixers" {
    ...
    export interface $OpticFinder<FT> {
        ...
        inField<GT>(arg0: string, arg1: $Type<GT>): $OpticFinder<FT>;
    }
    ...
    export class $View<A, B> extends $Record implements $App2<$View$Mu, A, B> {
        ...
        constructor(_function: $PointFree<$Function_<A, B>>);
        get nop(): boolean;
    }
    /**
     ...
     */
    export type $TypedOptic$Element_<S, T, A, B> = { tType?: $Type<any>, aType?: $Type<any>, bType?: $Type<any>, optic?: $Optic_<never, any, any, any, any>, sType?: $Type<any>,  } | [tType?: $Type<any>, aType?: $Type<any>, bType?: $Type<any>, optic?: $Optic_<never, any, any, any, any>, sType?: $Type<any>, ];
}
