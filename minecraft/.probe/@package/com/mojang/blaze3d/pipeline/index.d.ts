...
declare module "@package/com/mojang/blaze3d/pipeline" {
    ...
    export class $RenderTarget implements $FramebufferRenderTargetAccessor, $PerformanceRenderTargetExtension, $RenderTargetExtension {
        ...
        handler$zmg000$veil$createBuffers(arg0: $CallbackInfo): void;
        handler$zmg000$veil$bindRead(arg0: $CallbackInfo): void;
        handler$zmg000$veil$bindWrite(arg0: boolean, arg1: $CallbackInfo): void;
        handler$dkd000$sodium$blitToScreen(arg0: number, arg1: number, arg2: boolean, arg3: $CallbackInfo): void;
        createBuffers(arg0: number, arg1: number, arg2: boolean): void;
        handler$zmg000$veil$destroyBuffers(arg0: $CallbackInfo): void;
        handler$zln000$veil$copyDepthFrom(arg0: $RenderTarget, arg1: $CallbackInfo): void;
        handler$zln000$veil$clear(arg0: boolean, arg1: $CallbackInfo): void;
        handler$zmg000$veil$getColorTextureId(arg0: $CallbackInfoReturnable<any>): void;
        getDepthTextureId(): number;
        handler$zmg000$veil$getDepthTextureId(arg0: $CallbackInfoReturnable<any>): void;
        enableStencil(): void;
