...
declare module "@package/com/yungnickyoung/minecraft/yungsapi/world/structure/terrainadaptation/beardifier" {
     ...
     */
    export type $EnhancedBeardifierRigid_ = { pieceTerrainAdaptation?: $EnhancedTerrainAdaptation, pieceGroundLevelDelta?: number, rotation?: $Rotation_, pieceBoundingBox?: $BoundingBox,  } | [pieceTerrainAdaptation?: $EnhancedTerrainAdaptation, pieceGroundLevelDelta?: number, rotation?: $Rotation_, pieceBoundingBox?: $BoundingBox, ];
