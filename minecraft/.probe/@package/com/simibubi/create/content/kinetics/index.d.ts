...
declare module "@package/com/simibubi/create/content/kinetics" {
    export class $KineticNetwork implements $FlywheelAccessibleKineticNetwork {
        ...
        updateStress(): void;
        updateCapacity(): void;
        handler$bih000$bits_n_bobs$addSilently(arg0: $KineticBlockEntity, arg1: number, arg2: number, arg3: $CallbackInfo): void;
        handler$bih000$bits_n_bobs$add(arg0: $KineticBlockEntity, arg1: $CallbackInfo): void;
        handler$bih000$bits_n_bobs$remove(arg0: $KineticBlockEntity, arg1: $CallbackInfo): void;
        calculateStress(): number;
        handler$bih000$bits_n_bobs$updateNetworkHead(arg0: $CallbackInfo): void;
        redirect$dhc000$simulated$extraKineticsCapacity(arg0: $Level_, arg1: $BlockPos_): $BlockEntity;
        getActualCapacityOf(arg0: $KineticBlockEntity): number;
        redirect$dhc000$simulated$extraKineticsStress(arg0: $Level_, arg1: $BlockPos_): $BlockEntity;
