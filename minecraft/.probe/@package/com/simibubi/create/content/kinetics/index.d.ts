...
declare module "@package/com/simibubi/create/content/kinetics" {
    export class $KineticNetwork implements $FlywheelAccessibleKineticNetwork {
        ...
        updateNetwork(): void;
        handler$bke000$bits_n_bobs$updateNetworkHead(arg0: $CallbackInfo): void;
        updateCapacity(): void;
        handler$bke000$bits_n_bobs$addSilently(arg0: $KineticBlockEntity, arg1: number, arg2: number, arg3: $CallbackInfo): void;
        handler$bke000$bits_n_bobs$add(arg0: $KineticBlockEntity, arg1: $CallbackInfo): void;
        handler$bke000$bits_n_bobs$remove(arg0: $KineticBlockEntity, arg1: $CallbackInfo): void;
        calculateStress(): number;
        getActualCapacityOf(arg0: $KineticBlockEntity): number;
        getActualStressOf(arg0: $KineticBlockEntity): number;
        redirect$dlm000$simulated$extraKineticsCapacity(arg0: $Level_, arg1: $BlockPos_): $BlockEntity;
        redirect$dlm000$simulated$extraKineticsStress(arg0: $Level_, arg1: $BlockPos_): $BlockEntity;
