...
declare module "@package/net/neoforged/neoforge/client/entity/animation" {
     ...
     */
    export type $AnimationTarget_ = { keyframeTarget?: $AnimationKeyframeTarget_, inverseKeyframeTarget?: $AnimationKeyframeTarget_, channelTarget?: $AnimationChannel$Target_,  } | [keyframeTarget?: $AnimationKeyframeTarget_, inverseKeyframeTarget?: $AnimationKeyframeTarget_, channelTarget?: $AnimationChannel$Target_, ];
