...
declare module "@package/net/minecraft/client/gui" {
    ...
    export class $GuiGraphics implements $IGuiGraphicsExtension, $GuiGraphicsAccessor, $GuiGraphicsExtensions, $DrawContextAccessor$1, $DrawContextAccessor, $IMixinGuiGraphics, $GuiRenderStateSink {
        flush(): void;
    ...
    export class $Font implements $IFontExtension, $FontAccess, $JadeFont, $FontAccessor {
    ...
    export class $Gui implements $GuiAccessor, $IMixinGui {
        ...
        handler$hce008$betterf3$init(info: $CallbackInfo): void;
