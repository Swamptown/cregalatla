...
declare module "@package/net/minecraft/client/gui" {
    ...
    export class $Gui implements $GuiAccessor, $IMixinGui {
        handler$eki000$beansbackpacks$render(arg0: $GuiGraphics, arg1: $DeltaTracker, arg2: $CallbackInfo, arg3: $Player): void;
        renderSelectedItemName(arg0: $GuiGraphics, arg1: number): void;
        handler$icj00a$betterf3$init(info: $CallbackInfo): void;
        getPlayerVehicleWithHealth(): $LivingEntity;
        getVehicleMaxHearts(arg0: $LivingEntity): number;
        initModdedOverlays(): void;
        getLayerCount(): number;
        handler$fah000$collective$render(arg0: $GuiGraphics, arg1: $DeltaTracker, arg2: $CallbackInfo): void;
