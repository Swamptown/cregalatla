...
declare module "@package/net/minecraft/client/renderer/entity" {
    export class $EnderDragonRenderer$DragonModel extends $EntityModel<$EnderDragon> {
        handler$dcl002$xaerominimap$onRender(arg0: $PoseStack, arg1: $VertexConsumer, arg2: number, arg3: number, arg4: number, arg5: $CallbackInfo): void;
    ...
    export class $EntityRenderer<T extends $Entity> implements $EntityRendererAccessor, $EntityRendererExtension, $EntityRendererInter<any> {
        ...
        modifyReturnValue$ggf000$sable$getPackedLightCoords(arg0: number, arg1: $Entity, arg2: number): number;
    ...
    export class $PaintingRenderer extends $EntityRenderer<$Painting> {
        handler$zdc000$sodium_extra$render(arg0: $Painting, arg1: number, arg2: number, arg3: $PoseStack, arg4: $MultiBufferSource_, arg5: number, arg6: $CallbackInfo): void;
    ...
    export class $ArmorStandRenderer extends $LivingEntityRenderer<$ArmorStand, $ArmorStandArmorModel> {
        ...
        handler$ekd001$beansbackpacks$registerBackRenderer(arg0: $EntityRendererProvider$Context, arg1: $CallbackInfo): void;
    ...
    export class $AllayRenderer extends $MobRenderer<$Allay, $AllayModel> {
        handler$ekc000$beansbackpacks$registerBackRenderer(arg0: $EntityRendererProvider$Context, arg1: $CallbackInfo): void;
    ...
    export class $MobRenderer<T extends $Mob, M extends $EntityModel<T>> extends $LivingEntityRenderer<T, M> {
        md3b3139$vanillabackport$getShadowRadius$0(arg0: $Entity): number;
        getShadowRadius(arg0: T): number;
        shouldShowName(arg0: T): boolean;
        shadowRadius: number;
        static LEASH_RENDER_STEPS: number;
    ...
    export class $ItemFrameRenderer<T extends $ItemFrame> extends $EntityRenderer<T> {
        handler$zda000$sodium_extra$render(arg0: $ItemFrame, arg1: number, arg2: number, arg3: $PoseStack, arg4: $MultiBufferSource_, arg5: number, arg6: $CallbackInfo): void;
        handler$baa000$exposure$onItemFrameRender(entity: $ItemFrame, entityYaw: number, partialTicks: number, poseStack: $PoseStack, buffer: $MultiBufferSource_, packedLight: number, ci: $CallbackInfo): void;
    ...
    export class $ItemRenderer implements $ResourceManagerReloadListener, $ItemRendererAccessor$1, $ItemRendererAccessor$2, $ItemRendererAccessor, $IdentifiableResourceReloadListener {
        ...
        static hasAnimatedTexture$sodium_$md$3b3139$1(arg0: $ItemStack_): boolean;
        ...
        localvar$bac000$exposure$renderItem(model: $BakedModel, stack: $ItemStack_, displayContext: $ItemDisplayContext_, leftHand: boolean, poseStack: $PoseStack, buffer: $MultiBufferSource_, combinedLight: number, combinedOverlay: number): $BakedModel;
        handler$bbk000$ldlib2$injectRenderItem(arg0: $ItemStack_, arg1: $ItemDisplayContext_, arg2: boolean, arg3: $PoseStack, arg4: $MultiBufferSource_, arg5: number, arg6: number, arg7: $BakedModel, arg8: $CallbackInfo): void;
