...
declare module "@package/net/minecraft/world/level/levelgen/feature/rootplacers" {
     ...
     */
    export type $MangroveRootPlacement_ = { muddyRootsProvider?: $BlockStateProvider, muddyRootsIn?: $HolderSet_<$Block>, canGrowThrough?: $HolderSet_<$Block>, maxRootLength?: number, maxRootWidth?: number, randomSkewChance?: number,  } | [muddyRootsProvider?: $BlockStateProvider, muddyRootsIn?: $HolderSet_<$Block>, canGrowThrough?: $HolderSet_<$Block>, maxRootLength?: number, maxRootWidth?: number, randomSkewChance?: number, ];
