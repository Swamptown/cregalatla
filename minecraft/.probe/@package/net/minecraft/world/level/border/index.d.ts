...
declare module "@package/net/minecraft/world/level/border" {
    ...
    export class $WorldBorder implements $WorldBorderExtension {
        tick(): void;
        handler$gfb000$sable$isWithinBounds(arg0: number, arg1: number, arg2: number, arg3: $CallbackInfoReturnable<any>): void;
        getMaxX(): number;
        getMinZ(): number;
        getMaxZ(): number;
        handler$gfb000$sable$isInsideCloseToBorder(arg0: $Entity, arg1: $AABB_, arg2: $CallbackInfoReturnable<any>): void;
        ...
        wrapOperation$cci000$lithium$getUpdatedArea(arg0: $WorldBorder$BorderExtent, arg1: $Operation_<any>): $WorldBorder$BorderExtent;
