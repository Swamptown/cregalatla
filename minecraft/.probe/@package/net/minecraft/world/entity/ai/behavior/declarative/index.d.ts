...
import { $Function4_, $Function13_, $Function3, $Function4, $Function5, $Function6, $Function7, $Function8_, $Function8, $Function9, $Function3_, $Unit, $Function14_, $Function10_, $Function7_, $Function15_, $Function11_, $Function6_, $Function5_, $Function16_, $Function9_, $Function12_ } from "@package/com/mojang/datafixers/util";
...
declare module "@package/net/minecraft/world/entity/ai/behavior/declarative" {
    ...
    export class $BehaviorBuilder$Instance<E extends $LivingEntity> implements $Applicative<$BehaviorBuilder$Mu<E>, $BehaviorBuilder$Instance$Mu<E>> {
        ...
        lift1<A, R>(arg0: $App<$BehaviorBuilder$Mu<E>, $Function_<A, R>>): $Function<$App<$BehaviorBuilder$Mu<E>, A>, $App<$BehaviorBuilder$Mu<E>, R>>;
        ...
        ap2<A, B, R>(arg0: $App<$BehaviorBuilder$Mu<E>, $BiFunction_<A, B, R>>, arg1: $App<$BehaviorBuilder$Mu<E>, A>, arg2: $App<$BehaviorBuilder$Mu<E>, B>): $App<$BehaviorBuilder$Mu<E>, R>;
    ...
    export class $BehaviorBuilder<E extends $LivingEntity, M> implements $App<$BehaviorBuilder$Mu<E>, M> {
        ...
        static triggerIf<E extends $LivingEntity>(arg0: $Predicate_<E>, arg1: $OneShot<E>): $OneShot<E>;
    ...
    export interface $Trigger<E extends $LivingEntity> {
        trigger(arg0: $ServerLevel, arg1: E, arg2: number): boolean;
    }
    /**
    ...
    export class $MemoryAccessor<F extends $K1, Value> {
        ...
        constructor(arg0: $Brain<never>, arg1: $MemoryModuleType_<Value>, arg2: $App<F, Value>);
