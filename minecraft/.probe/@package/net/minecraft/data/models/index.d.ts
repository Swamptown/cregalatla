...
declare module "@package/net/minecraft/data/models" {
    ...
    export class $ModelProvider implements $DataProvider {
        ...
        handler$hck000$fabric_data_generation_api_v1$init(arg0: $PackOutput, arg1: $CallbackInfo): void;
    ...
    export class $ItemModelGenerators implements $ItemModelGeneratorsAccessor {
        ...
        static getGENERATED_TRIM_MODELS$create_$md$8e2dbe$0(): $List<any>;
        ...
        static get GENERATED_TRIM_MODELS$create_$md$8e2dbe$0(): $List<any>;
    }
