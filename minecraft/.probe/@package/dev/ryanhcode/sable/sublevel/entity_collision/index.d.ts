...
declare module "@package/dev/ryanhcode/sable/sublevel/entity_collision" {
     ...
     */
    export type $SubLevelEntityCollision$FirstCollisionInfo_ = { globalDirection?: $Vector3dc, localLocation?: $Vector3dc, bouncy?: boolean, block?: $BlockState_, horizontal?: boolean,  } | [globalDirection?: $Vector3dc, localLocation?: $Vector3dc, bouncy?: boolean, block?: $BlockState_, horizontal?: boolean, ];
