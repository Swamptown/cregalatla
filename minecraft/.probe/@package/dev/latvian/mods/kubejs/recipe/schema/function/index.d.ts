...
declare module "@package/dev/latvian/mods/kubejs/recipe/schema/function" {
    ...
    export interface $CustomRecipeSchemaFunctionRegistry {
        register(id: $ResourceLocation_, _function: $ResolvedRecipeSchemaFunction_): void;
    }
    /**
     * Values that may be interpreted as {@link $CustomRecipeSchemaFunctionRegistry}.
     */
    export type $CustomRecipeSchemaFunctionRegistry_ = ((id: $ResourceLocation, function: $ResolvedRecipeSchemaFunction) => void);
    ...
    export class $RecipeFunctionInstance extends $Record {
        ...
        arguments(): $List<$RecipeComponent<never>>;
        constructor(name: string, _function: $ResolvedRecipeSchemaFunction_);
        constructor(name: string, arguments: $List_<$RecipeComponent<never>>, _function: $ResolvedRecipeSchemaFunction_);
    }
    /**
