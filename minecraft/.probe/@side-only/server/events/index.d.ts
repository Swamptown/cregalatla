...
import { $CableType } from "@package/com/drmangotea/tfmg/content/electricity/connection/cable_type";
...
import { $PiglinPlayerBehaviorEventJS, $ExperiencePlayerEventJS } from "@package/com/almostreliable/morejs/features/misc";
...
import { $EntityTeleportsEventJS } from "@package/com/almostreliable/morejs/features/teleport";
...
import { $StructureLoadEventJS, $StructureAfterPlaceEventJS } from "@package/com/almostreliable/morejs/features/structure";
...
import { $PanelConnection } from "@package/net/liukrast/eg/api/logistics/board";
...
import { $FlamethrowerFuelType } from "@package/com/drmangotea/tfmg/content/items/weapons/flamethrover";
import { $LootScoreProviderType } from "@package/net/minecraft/world/level/storage/loot/providers/score";
import { $Electrode } from "@package/com/drmangotea/tfmg/content/machinery/vat/electrode_holder/electrode";
...
import { $PotionBrewingRegisterEvent } from "@package/com/almostreliable/morejs/features/potion";
...
import { $PanelType } from "@package/net/liukrast/eg/api/registry";
...
import { $PlayerEnchantEventJS, $EnchantmentTableServerEventJS } from "@package/com/almostreliable/morejs/features/enchantment";
...
import { $VillagerTradingEventJS, $SingleUpdateOfferEventJS, $WandererTradingEventJS, $PostUpdateOfferEventJS, $StartTradingEventJS } from "@package/com/almostreliable/morejs/features/villager/events";
...
declare global {
    ...
    namespace ServerEvents {
        ...
        function tags(type: "extra_gauges:panels", handler: ((event: TagEvent<$PanelType<any>>) => void)): void;
        ...
        function tags(type: "extra_gauges:panel_connections", handler: ((event: TagEvent<$PanelConnection<any>>) => void)): void;
        ...
        function tags(type: "tfmg:cable_types", handler: ((event: TagEvent<$CableType>) => void)): void;
        ...
        function tags(type: "tfmg:flamethrower_fuel/type", handler: ((event: TagEvent<$FlamethrowerFuelType>) => void)): void;
        function tags(type: "tfmg:electrodes", handler: ((event: TagEvent<$Electrode>) => void)): void;
